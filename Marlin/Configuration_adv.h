 ...
 */
#define USE_CONTROLLER_FAN //JMB
#if ENABLED(USE_CONTROLLER_FAN)
  #define CONTROLLER_FAN_PIN PC6           // Set a custom pin for the controller fan //JMB
  ...
  #define CONTROLLER_FAN_EDITABLE         // Enable M710 configurable settings //JMB
  #if ENABLED(CONTROLLER_FAN_EDITABLE)
    #define CONTROLLER_FAN_MENU             // Enable the Controller Fan submenu //JMB
  #endif
#endif
...
// @section bltouch
   ...
   */
  #define BLTOUCH_HS_MODE true //JMB
...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  #define PROBE_OFFSET_WIZARD       // Add a Probe Z Offset calibration option to the LCD menu //JMB
     ...
     */
    #define PROBE_OFFSET_WIZARD_START_Z -2.0 //JMB
...
#define BABYSTEPPING //JMB
  ...
  #define BABYSTEP_ZPROBE_OFFSET          // Combine M851 Z and Babystepping //JMB
 ...
 */
  ...
  #define PROBING_MARGIN_LEFT PROBING_MARGIN // JMB
  #define PROBING_MARGIN_RIGHT PROBING_MARGIN // JMB
  #define PROBING_MARGIN_FRONT PROBING_MARGIN // JMB
  #define PROBING_MARGIN_BACK PROBING_MARGIN // JMB
#endif

#if EITHER(MESH_BED_LEVELING, AUTO_BED_LEVELING_UBL)
  // Override the mesh area if the automatic (max) area is too large
  #define MESH_MIN_X 44 // JMB
  #define MESH_MIN_Y 32 // JMB
  #define MESH_MAX_X 200 // JMB
  #define MESH_MAX_Y 204 // JMB
#endif
 ...
 */
#define ADVANCED_PAUSE_FEATURE //JMB
 ...
 */
   ...
   */
  #define TMC_USE_SW_SPI //JMB
  //#define TMC_SPI_MOSI  -1
  //#define TMC_SPI_MISO  -1
  //#define TMC_SPI_SCK   -1

  #define DIAG_JUMPERS_REMOVED //JMB
  // @section tmc/serial
